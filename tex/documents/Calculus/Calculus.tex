...
Let me clear up a common misconception that I hear often: one does \emph{\textbf{not}} have to be some sort of `genius' in order to do Math.  Sure, math is \emph{hard}.  Some STEM fanatics love to sneer at the broad group of disciplines collectively referred to as the `humanities,'  In many ways, learning Math is like learning a foreign language.  
