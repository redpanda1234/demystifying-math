...
\[f:P \mapsto H\]
So, we can actually rephrase the above statements in terms of \textbf{injections}, \textbf{surjections}, and \textbf{bijections} (try this yourself first!  The diagrams given earlier can help).  With the the set of pigeons as our ``domain'' and the set of holes as our ``codomain,'' then we can rephrase our sketch in the following sense: 
...
\end{enumerate}
\end{sketch}
However, there's something a little unsettling about part 3. of the sketch above---namely, that 
